// Adapted by Bodmer to work with a NodeMCU and ILI9341 display.
// I used a 2.8" 320 x 240 pixel screen but the smaller 2.2" will
// also be fine.
//
...
// 2. Add another eye to the screen
//
// With one eye drawn the code runs at 30fps which is quite reasonable.

// Original header for this sketch is below (Note: the technical text no longer
// applies to this version of the sketch):
/*
//--------------------------------------------------------------------------
...
#define IRIS_MAX      420 // Clip upper "
...
struct {
  TFT_ILI9341_ESP tft; // OLED/eye[e].tft object
  uint8_t     cs;      // Chip select pin
  eyeBlink    blink;   // Current blink state
} eye[] = { // OK to comment out one of these for single-eye display:
  TFT_ILI9341_ESP(),SELECT_L_PIN,{WINK_L_PIN,NOBLINK},
  TFT_ILI9341_ESP(),SELECT_R_PIN,{WINK_R_PIN,NOBLINK},
};
